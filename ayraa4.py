"""
Ayurveda Personal AI — Dr. Ayra (Cloud-Compatible Version with Sidebar, No Login Required)
-------------------------------------------------------------------------------------------
This version is fully compatible with GitHub deployment or any cloud service (Streamlit Cloud, Hugging Face Spaces, etc.).
It removes all admin or login requirements and uses a sidebar for inputs.
